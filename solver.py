...
class PuzleSolver:
    ...
    def __background_preprocessing(self, y_sup, y_inf):
        ...
        # Aplicar umbralización adaptativa para reducir el ruido
        background = cv2.adaptiveThreshold(background, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY, 11, 2)
    ...
    def __sobel_operator(self, img_path):
        scale = 1
        delta = 0
        # Utilizar kernel de tamaño 3x3 y sobel vertical y horizontal para aumentar la detección de bordes
